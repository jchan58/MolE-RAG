#!/usr/bin/env python
"""
baseline.py — FreeSolv baseline (SMILES only).
...
Example:
  python scripts/baseline/freesolv_baseline.py
"""
...
def build_user_prompt(smiles, task_name=None):
    task_name = task_name or "FreeSolv"
    ...
    return (
        "Given the SMILES string of a molecule, predict its hydration free energy in kcal/mol. "
        ""
        ...
        try:
            for prompt_type in PROMPT_TYPES:
                ...
                for idx, example in valid_examples:
                    ...
                    task_name = example.get("task", "FreeSolv")
