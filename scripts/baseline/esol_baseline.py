#!/usr/bin/env python
"""
baseline.py — ESOL baseline (SMILES only).
...
Example:
  python scripts/baseline/esol_baseline.py
"""
...
def build_user_prompt(smiles, task_name=None):
    ...
    return (
        "Given the SMILES string of a molecule, predict its log aqueous solubility. "
        ""
        ...
        try:
            for prompt_type in PROMPT_TYPES:
                ...
                for idx, example in valid_examples:
                    ...
                    task_name = example.get("task", "ESOL")
