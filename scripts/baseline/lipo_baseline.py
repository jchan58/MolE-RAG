#!/usr/bin/env python
"""
baseline.py — Lipo baseline (SMILES only).
...
Example:
  python scripts/baseline/lipo_baseline.py
"""
...
def build_user_prompt(smiles, task_name=None):
    ...
    return (
        "Given the SMILES string of a molecule, predict the octanol/water distribution coefficient logD at pH 7.4. "
        ""
        ...
        try:
            for prompt_type in PROMPT_TYPES:
                ...
                for idx, example in valid_examples:
                    ...
                    task_name = example.get("task", "Lipo")
