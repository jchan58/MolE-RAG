#!/usr/bin/env python
"""
baseline.py — Tox21 baseline (SMILES only).
...
Example:
  python scripts/baseline/tox21_baseline.py
"""
...
def build_user_prompt(smiles, task_name=None):
    task_name = task_name or "tox21_assay"

    if TASK_TYPE == "classification":
        return (
            "Given the SMILES string of a molecule, predict whether it is active in the Tox21 assay listed in the task field. "
        ...
        try:
            for prompt_type in PROMPT_TYPES:
                ...
                for idx, example in valid_examples:
                    ...
                    task_name = example.get("task", "tox21_assay")
